...
```json
{
  "file_path": "temp/reference_small.xlsx",
  "total_rows": 1999,
  "total_columns": 27,
  "columns": {
    "Record ID": {
    ...
    "Status": {
      ...
      "unique_count": 2,
      "cardinality_level": "low",
      "pattern": "Common patterns: XXXXXXXXX, XXXXXXXXXXX",
      "samples": [
        "Pensioner",
        "Beneficiary"
      ],
    ...
    "Primary Mortality Scalar Flag": {
      ...
      "unique_count": 2,
      "cardinality_level": "low",
      "pattern": "Common patterns: #_XXXXXXXXXXX, #_XXXXXXXX",
      "samples": [
        "1_NonDisabled",
        "2_Disabled"
      ],
    ...
    "Secondary Mortality Scalar Flag": {
      ...
      "unique_count": 1,
      "cardinality_level": "single",
      "pattern": "Consistent: #_XXXXXXXXXXX",
      "samples": [
        "1_NonDisabled"
      ],
      "mixed_type": false
    },
    "Secondary Mortality Improvement Flag": {
      "data_type": "string",
      "likely_role": "categorical",
      "percent_populated": 34.72,
      "percent_unique": 0.4,
